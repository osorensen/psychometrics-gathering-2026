...
with polynomial matrices $\boldsymbol{X}(L) = \sum_{l=0}^{K} \boldsymbol{X}_{l} L^{l}$.
...
with augmented latent states $\tilde{\boldsymbol{\eta}}_{1,it}$ after some pretty tedious algebra.
